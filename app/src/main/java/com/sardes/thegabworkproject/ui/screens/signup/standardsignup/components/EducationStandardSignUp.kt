...
fun EducationStandardSignUp(
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        LazyColumn(
            ...
            uiStateStandard?.education?.forEach { education ->
                item {
                    EducationCard(
...
private fun PreviewEducationSeekerSignUp() {
    EducationStandardSignUp(
        uiStateStandard = null, viewModel = null, focusRequester = FocusRequester.Default,
        emptyList<CompteStandard.Education>().toMutableStateList()
    )
}