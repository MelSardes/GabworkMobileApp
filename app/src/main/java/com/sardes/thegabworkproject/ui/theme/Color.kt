...
val SmoothBrown = Color(0xFF897C7C)
val GreenFlag = Color(0xFF00995D)
val YellowFlag = Color(0xFFF4CA15)
val BlueFlag = Color(0xFF3469B1)
...
object GWpalette{
    val Gunmetal    = Color(0xFF222833)
    val DarkLiver   = Color(0xFF4A4349)
    val LackCoral   = Color(0xFF515C70)
    val CoolGrey    = Color(0xFF8C91A5)
